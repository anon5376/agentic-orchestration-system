...
function TemplateEditor({ editor, presets, manifest, executionAllowedHarnesses, onCancel, onSave }) {
  ...
  const harnesses = manifest?.enumerations?.harnesses || ['local', 'codex', 'claude', 'api', 'ollama', 'command'];
