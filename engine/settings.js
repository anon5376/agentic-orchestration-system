...
export const SETTING_DEFINITIONS = Object.freeze([
  ...
  { key: 'execution.allowedHarnesses', group: 'models_harnesses', schema: t.array(t.enumOf(KNOWN_HARNESSES), { unique: true, minItems: 1 }), default: ['local', 'codex', 'claude', 'openai'], scopes: ['global', 'project'], description: 'Harnesses a template may select. Adapters still fail closed until configured and ready.' },
